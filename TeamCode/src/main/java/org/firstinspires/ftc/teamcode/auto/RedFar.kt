...
class RedFar: LinearOpMode() {
    override fun runOpMode() {
        ...
        val traj = drive.actionBuilderPath(startPose)
            ...
            .stopAndAdd(robot.autoFireFour())
            .setTangent(toRadians(0.0))
            .splineToLinearHeading(Pose2d(-3.0, 14.0, toRadians(90.0)), toRadians(0.0))
            .endTrajectory()
            .setTangent(toRadians(90.0))
            .splineToSplineHeading(Pose2d(-3.0, 40.0, toRadians(90.0)), toRadians(90.0))
            .endTrajectory()
            ...
            // start intake
            .splineToSplineHeading(Pose2d(20.0, 14.0, toRadians(90.0)), toRadians(90.0))
            .endTrajectory()
            .splineToSplineHeading(Pose2d(20.0, 36.0, toRadians(90.0)), toRadians(90.0))
            .endTrajectory()
            .setTangent(toRadians(215.0))
            .splineToSplineHeading(shootPose, toRadians(240.0))
            .afterTime(0.1, InstantAction { MecanumDrive.preciseEnd = true })
            .stopAndAdd(robot.autoFireFour())
            .setTangent(toRadians(30.0))
            // start intake
            .splineToSplineHeading(Pose2d(43.0, 14.0, toRadians(90.0)), toRadians(90.0))
            //.endTrajectory()
            .splineToSplineHeading(Pose2d(43.0, 40.0, toRadians(90.0)), toRadians(90.0))
